...
tableextension 87570 "wan Sales Header BlkOrder" extends "Sales Header"
{
    fields
    {
        field(87500; "wan Blanket Order No."; Code[20])
        {
            ...
            begin
                ...
                if Page.RunModal(Page::"wan Sales Blanket Order Lookup", BlanketOrder) = Action::LookupOK then
